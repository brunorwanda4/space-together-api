...
use crate::{
    domain::{
        ...
        studen::{Student, StudentPartial, StudentStatus},
    },
    errors::AppError,
    models::{
        id_model::IdType,
...
impl StudentService {
    ...
    // CREATE
    // =========================
    pub async fn create(&self, dto: Student) -> Result<Student, AppError> {
        ...
        repo.create::<Student>(extract_valid_fields(full_doc), None)
            .await
    }
